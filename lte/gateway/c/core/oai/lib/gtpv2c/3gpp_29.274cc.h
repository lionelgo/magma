...
class gtpv2c_imsi_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_imsi_ie(const gtpc_imsi_t& i) : gtpv2c_ie(GTP_IE_IMSI) {
    // avoid using b[]
  ...
  //--------
  void to_core_type(gtpc_imsi_t& i) {
...
class gtpv2c_cause_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_cause_ie(const gtpc_cause_t& i) : gtpv2c_ie(GTP_IE_CAUSE) {
  ...
  void to_core_type(gtpc_cause_t& c) {
...
class gtpv2c_aggregate_maximum_bit_rate_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_aggregate_maximum_bit_rate_ie(const gtpc_ambr_t& ambr)
  ...
  //--------
  void to_core_type(gtpc_ambr_t& ambr) {
...
class gtpv2c_eps_bearer_id_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_eps_bearer_id_ie(const gtpc_ebi_t& e)
  ...
  //--------
  void to_core_type(gtpc_ebi_t& e) { e.ebi = u1.bf.eps_bearer_id; }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    os.write(reinterpret_cast<const char*>(&u1.b), sizeof(u1.b));
...
class gtpv2c_ip_address_ie : public gtpv2c_ie {
 public:
  ...
  bool is_ipv4;
  //--------
  explicit gtpv2c_ip_address_ie(const gtpc_ip_address_t& i)
  ...
  //--------
  void to_core_type(gtpc_ip_address_t& i) {
    i.is_ipv4 = is_ipv4;
    if (is_ipv4) {
...
#define MSISDN_BCD8_SIZE                                                       \
  ...
  //--------
  explicit gtpv2c_msisdn_ie(const gtpc_msisdn_t& m) : gtpv2c_ie(GTP_IE_MSISDN) {
    // avoid using b[]
  ...
  //--------
  void to_core_type(gtpc_msisdn_t& m) {
...
class protocol_or_container_id : public stream_serializable {
 public:
  ...
  explicit protocol_or_container_id(const pco_protocol_or_container_id_t& p)
      : protocol_id(p.id),
        length_of_protocol_id_contents(p.length),
 ...
 public:
  ...
  explicit gtpv2c_pco_ie(const protocol_configuration_options_t& p)
    ...
    for (int i = 0; i < p.num_protocol_or_container_id; i++) {
      ...
      tlv.length += (p.protocol_or_container_ids[i].length + 3);
    }
  ...
  void to_core_type(protocol_configuration_options_t& p) {
    ...
    for (auto& x : protocol_or_container_ids) {
      p.protocol_or_container_ids[i].id     = x.protocol_id;
      p.protocol_or_container_ids[i].length = x.length_of_protocol_id_contents;
      p.protocol_or_container_ids[i].contents = blk2bstr(
          x.protocol_id_contents.c_str(), x.protocol_id_contents.length());
      i++;
    }
  }
  //--------
...
class gtpv2c_bearer_flags_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_bearer_flags_ie(const gtpc_bearer_flags_t& b)
      : gtpv2c_ie(GTP_IE_CHARGING_ID) {
    u1.b       = 0;
    u1.bf.asi  = b.asi;
    u1.bf.vind = b.vind;
  ...
  //--------
  void to_core_type(gtpc_bearer_flags_t& b) {
...
class gtpv2c_pdn_type_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_pdn_type_ie(const gtpc_pdn_type_t& p)
  ...
  //--------
  void to_core_type(gtpc_pdn_type_t& p) { p.pdn_type = u1.bf.pdn_type; }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
    os.write(reinterpret_cast<const char*>(&u1.b), sizeof(u1.b));
...
class gtpv2c_paa_ie : public gtpv2c_ie {
 public:
  ...
  in_addr ipv4_address;  // network byte order
  //--------
  explicit gtpv2c_paa_ie(const gtpc_paa_t& p)
  ...
  //--------
  void to_core_type(gtpc_paa_t& p) {
...
class gtpv2c_bearer_qos_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_bearer_qos_ie(const gtpc_bearer_qos_t& b)
  ...
  //--------
  void to_core_type(gtpc_bearer_qos_t& b) {
    b           = {0};
    b.pci       = u1.bf.pci;
    b.pl        = u1.bf.pl;
    b.pvi       = u1.bf.pvi;
...
class gtpv2c_flow_qos_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_flow_qos_ie(const gtpc_flow_qos_t& b)
  ...
  //--------
  void to_core_type(gtpc_flow_qos_t& b) {
    b           = {0};
    b.label_qci = label_qci;
...
class gtpv2c_rat_type_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_rat_type_ie(const gtpc_rat_type_t& r)
  ...
  //--------
  void to_core_type(gtpc_rat_type_t& r) { r.rat_type = rat_type; }
  //--------
  void dump_to(std::ostream& os) {
    tlv.dump_to(os);
...
class gtpv2c_fully_qualified_teid_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_fully_qualified_teid_ie(const gtpc_fteid_t& f)
  ...
  //--------
  void to_core_type(gtpc_fteid_t& f) {
    f                = {0};
    f.v4             = u1.bf.v4;
    f.v6             = u1.bf.v6;
...
class gtpv2c_apn_restriction_ie : public gtpv2c_ie {
 public:
  ...
  gtpv2c_apn_restriction_ie& operator=(gtpv2c_apn_restriction_ie other) {
    this->gtpv2c_ie::operator=(other);
    restriction_type_value = other.restriction_type_value;
    return *this;
  }
  //--------
...
class gtpv2c_node_type_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_node_type_ie(const gtpc_node_type_t& n)
  ...
  //--------
  void to_core_type(gtpc_node_type_t& n) {
    n           = {0};
...
class gtpv2c_ran_nas_cause_ie : public gtpv2c_ie {
 public:
  ...
  //--------
  explicit gtpv2c_ran_nas_cause_ie(const ran_nas_gtpc_cause_t& c)
      : gtpv2c_ie(GTP_IE_RAN_NAS_CAUSE) {
    tlv.length            = 1;
    u1.bf.protocol_type   = c.protocol_type;
    u1.bf.gtpc_cause_type = c.gtpc_cause_type;
  ...
  gtpv2c_ran_nas_cause_ie& operator=(gtpv2c_ran_nas_cause_ie other) {
    this->gtpv2c_ie::operator=(other);
    u1 = other.u1;
    cause_value = other.cause_value;
    return *this;
  }
  //--------
  void to_core_type(ran_nas_gtpc_cause_t& c) {
    c                 = {0};
    c.protocol_type   = u1.bf.protocol_type;
    c.gtpc_cause_type = u1.bf.gtpc_cause_type;
  ...
  //--------
  void to_core_type(gtpv2c_ies_container& s, const uint8_t instance) {
    ran_nas_gtpc_cause_t ran_nas_cause = {};
