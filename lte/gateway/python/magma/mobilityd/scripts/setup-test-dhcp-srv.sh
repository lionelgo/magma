...
ip netns exec    "$prefix"dhcp_srv   ifconfig  "$prefix"uplink_p1 192.168.138.100/24
...
ip netns exec    "$prefix"dhcp_srv   ip addr add 192.168.138.211  dev "$prefix"uplink_p1
